...
function draw() {
  ...
  //display the plinkos 
  for (var jj = 0; jj < plinkos.length; jj++) {
    plinkos[jj].display();   

  }
   
  //display the divisions
  for (var kk = 0; kk < divisions.length; kk++) {
    divisions[kk].display();
  }
  ...
  if(frameCount%90===0){
    particles.push(new Particle(random(width/2-210, width/2+210),10,10))
